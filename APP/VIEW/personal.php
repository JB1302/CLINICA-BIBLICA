...
// Manejo de solicitudes AJAX para obtener detalle de personal
if (isset($_GET['ajax']) && $_GET['ajax'] === 'detalle') {
    header('Content-Type: application/json');
    echo json_encode($controller->obtenerDetalle());
    exit;
}
// Manejo de solicitudes POST para crear, actualizar o eliminar personal
...
<body class="d-flex flex-column min-vh-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-sm btn-info me-1" onclick="verDetalle(<?= $p['ID_PERSONAL'] ?>)"
                                title="Ver detalle">
                                <i class="fa-solid fa-eye"></i>
                            </button>
                            <button class="btn btn-sm btn-warning me-1 btn-editar" data-bs-toggle="modal"
                                data-bs-target="#modalEditar" data-id="<?= htmlspecialchars($p['ID_PERSONAL'] ?? '') ?>"
                                ...
                                data-horario="<?= htmlspecialchars($p['HORARIO_TRABAJO'] ?? '') ?>" data-fecha="<?php 
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="edit-papellido" name="PRIMER_APELLIDO"
                                    required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="edit-fecha-contratacion"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (modalEditar) {
            modalEditar.addEventListener('show.bs.modal', function(event) {
                ...
                // Obtiene los datos del botón que activó el modal
    ...
    function verDetalle(idPersonal) {
        ...
        modal.show();
        // Obtener detalle del personal vía AJAX
