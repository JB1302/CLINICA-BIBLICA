...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="container py-5">
        ...
        <div class="alert alert-<?= ($_GET['ok'] ?? '0') == '1' ? 'success' : 'danger' ?> alert-dismissible fade show"
            role="alert">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-sm btn-warning me-1" data-bs-toggle="modal"
                                data-bs-target="#modalEditar" data-id="<?= htmlspecialchars($m['ID_MEDICO']) ?>"
    ...
    <div class="modal fade" id="modalEliminarMedico" tabindex="-1" aria-labelledby="lblEliminarMedico"
        aria-hidden="true">
        <div class="modal-dialog">
    ...
    <script>
    // Manejo de datos en modales
    document.addEventListener('DOMContentLoaded', () => {
        // Prellenar datos en el modal de editar
        ...
        if (editarModal) {
            editarModal.addEventListener('show.bs.modal', event => {
                ...
                document.getElementById('editEspecialidad').value = button.getAttribute(
        ...
        // Precargar ID en el modal ELIMINAR médico
        ...
        if (eliminarModal) {
            eliminarModal.addEventListener('show.bs.modal', event => {
                ...
                // Setear el ID en el campo oculto
                if (inputDelete) {
