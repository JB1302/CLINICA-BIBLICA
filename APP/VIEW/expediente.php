...
<body class="d-flex flex-column min-vh-100">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-info me-1"
                                        onclick="verDetalle(<?= $exp['ID_EXPEDIENTE'] ?>)" title="Ver detalle">
                                        <i class="fa-solid fa-eye"></i>
                                    </button>
                                    <button class="btn btn-sm btn-warning"
                                        onclick="editarExpediente(<?= $exp['ID_EXPEDIENTE'] ?>, '<?= htmlspecialchars($exp['NOTAS'] ?? '', ENT_QUOTES) ?>')"
                                        title="Editar">
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="nuevo-notas" name="notas" rows="3" maxlength="100"
                                placeholder="Notas iniciales del expediente"></textarea>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="editar-notas" name="notas" rows="3"
    ...
    <script>
    // // Abre el modal de edición y precarga los datos del expediente
    ...
    // Muestra el detalle del expediente en un modal
